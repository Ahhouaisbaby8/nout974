...
export default function Home() {
  ...
  const handleBirdClick = () => {
    ...
    setBirdFlying(true)
    setTimeout(() => setBirdFlying(false), 11000)   // durée de l'animation pailleTour (traversée lente)
  }
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Paille-en-queue (oiseau emblématique 974) qui planent — subtil, translucide */}
        {[1, 2].map((n) => (
          <div key={n} className={`absolute top-0 left-0 pointer-events-none select-none paille-fly${n}`}>
            <svg width="58" height="36" viewBox="0 0 120 70" fill="none">
              ...
              {/* longue queue effilée = signature du paille-en-queue */}
        ...
        <button
          ...
          style={{
            ...
            animation: birdFlying ? 'pailleTour 11s linear forwards' : 'float974 6s ease-in-out infinite',
          }}
        >
