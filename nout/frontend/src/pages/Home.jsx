...
export default function Home() {
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto w-full text-center">
          ...
          <p className="hero-fade-up-1 text-[16px] text-white/75 mb-8 font-light">
            La marketplace 100&nbsp;% réunionnaise, entre particuliers
          </p>
      ...
      {/* ── F) NOUT PRO — offre entreprises (SIRET requis) ───────────────────────
           Visible publiquement ; la mention « ouverture prochaine » évite de promettre
           une souscription qui n'est pas encore ouverte. */}
      {(
        <section className="max-w-7xl mx-auto px-4 py-14">
          <div className="rounded-3xl border border-nout-border bg-white shadow-nout-md overflow-hidden">
            <div className="grid md:grid-cols-2">
              <div className="p-8 sm:p-10 flex flex-col justify-center">
                ...
                <p className="text-nout-muted text-[14.5px] leading-relaxed mb-5">
                  ...
                  la livraison 974 et la protection acheteur de NOUT déjà intégrés.
                  CGV, mentions légales et conformité générées automatiquement.
                </p>
                ...
                <div className="flex gap-2.5 flex-wrap">
                  <button onClick={() => navigate('/boutique-templates')}
                          className="btn-primary !px-6">Voir les templates</button>
                  <button onClick={() => navigate('/boutique-creer')}
                          className="btn-secondary !px-6">Créer ma boutique</button>
                </div>
              </div>
              <div className="hidden md:block bg-[#EEF3F8] p-8">
                <div className="h-full rounded-2xl bg-white shadow-nout-md flex flex-col items-center justify-center text-center px-6">
                  <p className="font-title font-bold text-[19px] text-nout-texte">Propulsé par NOUT</p>
                  <p className="text-nout-muted text-[13px] mt-2 leading-relaxed">
                    Vos clients paient en sécurité, vous êtes payé après la livraison —
                    exactement comme sur NOUT.
                  </p>
                  <p className="text-[12px] text-nout-muted mt-4 leading-relaxed">
                    Le service ouvre bientôt. Vous pouvez déjà découvrir les templates et
                    construire votre boutique d'essai.
                  </p>
                </div>
              </div>
            </div>
